...
{
  ((mt != ((void *)0)) ? (void) (0) : (__assert_fail ("mt != ((void *)0)", "test.c", 226, __PRETTY_FUNCTION__), (void) (0)));
...
mt_allocate (struct libavl_allocator *allocator, size_t size)
{
  ...
  switch (mt->policy)
    ...
    default:
      ((0) ? (void) (0) : (__assert_fail ("0", "test.c", 358, __PRETTY_FUNCTION__), (void) (0)));
    }
}
...
option_init (const struct option *options, char **args)
{
  ...
  ((options != ((void *)0) && args != ((void *)0)) ? (void) (0) : (__assert_fail ("options != ((void *)0) && args != ((void *)0)", "test.c", 428, __PRETTY_FUNCTION__), (void) (0)));
...
handle_short_option (struct option_state *state, char **argp)
{
  ...
  ((state != ((void *)0) && state->short_next != ((void *)0) && *state->short_next != '\0' && state->options != ((void *)0)) ? (void) (0) : (__assert_fail ("state != ((void *)0) && state->short_next != ((void *)0) && *state->short_next != '\\0' && state->options != ((void *)0)", "test.c", 449, __PRETTY_FUNCTION__), (void) (0)));
...
handle_long_option (struct option_state *state, char **argp)
{
  ...
  ((state != ((void *)0) && state->arg_next != ((void *)0) && *state->arg_next != ((void *)0) && state->options != ((void *)0) && argp != ((void *)0)) ? (void) (0) : (__assert_fail ("state != ((void *)0) && state->arg_next != ((void *)0) && *state->arg_next != ((void *)0) && state->options != ((void *)0) && argp != ((void *)0)", "test.c", 485, __PRETTY_FUNCTION__), (void) (0)));
...
{
  ((state != ((void *)0) && argp != ((void *)0)) ? (void) (0) : (__assert_fail ("state != ((void *)0) && argp != ((void *)0)", "test.c", 530, __PRETTY_FUNCTION__), (void) (0)));
  ...
  for (;;)
    {
      ...
      switch (id)
        ...
        case 'i':
          {
            ...
            ((sizeof orders / sizeof *orders == INS_CNT) ? (void) (0) : (__assert_fail ("sizeof orders / sizeof *orders == INS_CNT", "test.c", 724, __PRETTY_FUNCTION__), (void) (0)));
        ...
        case 'd':
          {
            ...
            ((sizeof orders / sizeof *orders == DEL_CNT) ? (void) (0) : (__assert_fail ("sizeof orders / sizeof *orders == DEL_CNT", "test.c", 745, __PRETTY_FUNCTION__), (void) (0)));
            for (iter = orders; ; iter++)
        ...
        default:
          ((0) ? (void) (0) : (__assert_fail ("0", "test.c", 844, __PRETTY_FUNCTION__), (void) (0)));
        }
    }
}
...
gen_insertions (size_t n, enum insert_order insert_order, int insert[])
{
  ...
  switch (insert_order)
    ...
    default:
      ((0) ? (void) (0) : (__assert_fail ("0", "test.c", 938, __PRETTY_FUNCTION__), (void) (0)));
    }
}
               ...
               const int *insert, int *delete)
{
  ...
  switch (delete_order)
    ...
    default:
      ((0) ? (void) (0) : (__assert_fail ("0", "test.c", 973, __PRETTY_FUNCTION__), (void) (0)));
    }
}
  ...
  while (opts.iter_cnt--)
    {
...

      {
        ...
        switch (opts.test)
          ...
          default:
            ((0) ? (void) (0) : (__assert_fail ("0", "test.c", 1083, __PRETTY_FUNCTION__), (void) (0)));
          }
