...
case SYSCALL_YIELD: if (processTable[processToRun].priority == processTable[executingProcessID].priority){
{ 
...
ComputerSystem_DebugMessage(115, 'p', executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName), executingProcessID, (programList[processTable[oldProcess].programListIndex]->executableName)); } }
