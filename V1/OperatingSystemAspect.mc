...
int OperatingSystem_LongTermScheduler() {
  ...
  for (i = 0; programList[i] != ((void *)0) && i < 20; i++) {
    ...
    case -1:
      ...
      ComputerSystem_DebugMessage(104, 'e', programList[i]->executableName,
                                  "it does not exists");
      break;
...
void OperatingSystem_RestoreContext(int PID) {
  ...
  Processor_CopyInSystemStack(300 - 1,
                              processTable[PID].copyOfPCRegister);
  Processor_CopyInSystemStack(300 - 2,
...
void OperatingSystem_SaveContext(int PID) {
  ...
  processTable[PID].copyOfPCRegister =
      Processor_CopyFromSystemStack(300 - 1);


  processTable[PID].copyOfPSWRegister =
      Processor_CopyFromSystemStack(300 - 2);
}
