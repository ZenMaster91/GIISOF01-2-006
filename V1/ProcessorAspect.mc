...
void Processor_InitializeInterruptVectorTable(
  ...
  interruptVectorTable[SYSCALL_BIT] =
      interruptVectorInitialAddress;
  interruptVectorTable[EXCEPTION_BIT] =
      interruptVectorInitialAddress + 2;
}
...
void Processor_FetchInstruction() {
  ...
  if (MMU_readMemory() == 1) {
    ...
    ComputerSystem_DebugMessage(1, 'h', registerIR_CPU.operationCode,
...
void Processor_DecodeAndExecuteInstruction() {
  ...
  case 'o':
    ...
    ComputerSystem_DebugMessage(3, 'h', registerPC_CPU,
